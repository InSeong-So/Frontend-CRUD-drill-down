...
```sh
# cloning project
git clone https://github.com/InSeong-So/Frontend-drill-down.git
...
다양하게 사용하여 hitory를 남깁니다.

<br>
<hr>

## 📝 히스토리
> **rule 1** : 구현 형식은 기존과 완전히 다르게 만들기 🖍

> **rule 2** : 테스트 프레임워크, 빌더는 최신 트렌드를 적용해보기

- [**🔍 첫 번째 구현**](https://github.com/InSeong-So/TS-menu-manage-app/tree/main/history/version-01) : 기존 바닐라 자바스크립트 앱의 완성도도 낮았으며, 타입스크립트를 처음 공부하면서 많이 미숙합니다.
