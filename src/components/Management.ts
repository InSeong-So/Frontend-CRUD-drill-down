...
export default class Management extends Component {
  ...
  private _currentCategoryText: string;
  ...
  mount() {
    const $inputItem = this._utils.$('#espresso-menu-name') as HTMLInputElement;
    const $menuAddButton = this._utils.$(
      '#espresso-menu-submit-button',
    ) as HTMLButtonElement;
    const $list = this._utils.$('#espresso-menu-list') as HTMLUListElement;
